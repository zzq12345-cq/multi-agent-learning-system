...
python -c "from app.api.chat import router; print('Chat API OK')"
```
...
git commit -m "feat: WebSocket 推送 Agent 协作事件流（agent_start/end/token/route/done）"
```
