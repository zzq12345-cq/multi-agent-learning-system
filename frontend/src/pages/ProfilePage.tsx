    ...
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto bg-gray-50">
        <div className="max-w-2xl mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-4 shadow-sm">
            <div className="flex items-center gap-5">
              <div className="relative group">
                <div className="w-20 h-20 rounded-full bg-blue-100 border-2 border-blue-200 flex items-center justify-center overflow-hidden">
                  {profile?.avatar ? (
                    <img
                      src={profile.avatar}
                      alt="头像"
                ...
                <button
                  ...
                  className="absolute bottom-0 right-0 w-7 h-7 bg-blue-500 rounded-full flex items-center justify-center text-white shadow-md hover:bg-blue-600 transition-colors"
                  aria-label="上传头像"
                >
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 rounded-xl border border-gray-100 hover:bg-gray-50 transition-colors"
              >
              ...
              {showChangePwd && (
                <div className="px-4 py-3 bg-gray-50 rounded-xl space-y-2">
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-200 rounded-lg text-xs outline-none focus:border-blue-400"
                  />
                  <input
                    type="password"
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-blue-500 text-white text-xs rounded-lg disabled:opacity-50"
                  >
                    确认修改
                  </button>
                </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 rounded-xl border border-gray-100 hover:bg-red-50 transition-colors"
              >
                <span className="text-xs text-gray-700 font-medium">
                  清除学习记录
                </span>
          ...
          {/* 消息提示 */}
          {message && (
            <div className="fixed bottom-6 left-1/2 -translate-x-1/2 px-4 py-2 bg-gray-900 text-white text-xs rounded-full shadow-lg">
              {message}
            </div>
          )}
        </div>
